...
void Vf1_fsm_comb___024root__trace_chg_sub_0(Vf1_fsm_comb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vf1_fsm_comb___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_fsm_comb___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vf1_fsm_comb___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vf1_fsm_comb___024root__trace_chg_sub_0(Vf1_fsm_comb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_fsm_comb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_fsm_comb___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgBit(oldp+5,(vlSelf->f1_fms_comb__DOT__tick));
    bufp->chgIData(oldp+6,(vlSelf->f1_fms_comb__DOT__myF1_fsm__DOT__current_state),32);
    bufp->chgIData(oldp+7,((((((((((0U == vlSelf->f1_fms_comb__DOT__myF1_fsm__DOT__current_state) 
                                                   ...
                                                   ((4U 
                                                    ...
                                                    ((5U 
                                                     ...
                                                     ((6U 
                                                       ...
                                                       : 8U)))))))
                             : 0U)),32);
    bufp->chgSData(oldp+8,(vlSelf->f1_fms_comb__DOT__myTicker__DOT__count),16);
}

void Vf1_fsm_comb___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_fsm_comb___024root__trace_cleanup\n"); );
    // Init
    Vf1_fsm_comb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vf1_fsm_comb___024root*>(voidSelf);
    Vf1_fsm_comb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
